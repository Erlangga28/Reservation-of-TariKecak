                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="manage.php"><i class="menu-icon icon-user"></i>Manage Students </a>
                                </li>
                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="SELECT * from buyticket where (id='$s' or Name like '%$s%') and id<>'ADMIN'";
                                        }
                                    else
                                        $sql="SELECT * from buyticket where id<>'ADMIN'";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        <td>
                                        <center>
                                            <a href="studentdetails.php?id=<?php echo $id; ?>" class="btn btn-success">Details</a>
